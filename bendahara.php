<?php
	include 'koneksi.php';
	$data_user = mysql_fetch_array(mysql_query("SELECT * FROM user WHERE id_user = 'RDB' "));
?>
<html>
	<head>
		...
		<body>
			...
			<div id="table-data">
				<table border="0" cellspacing="0">
					<tr>
						<td rowspan="7"><img src="foto_user/<?php echo $data_user['foto']; ?>" width="300" height="350" /></td>
						<th>Nama Lengkap</th>
